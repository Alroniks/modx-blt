<?php
/**
 * User Belarusian Latin lexicon topic
 *
 * @language en
 * @package modx
 * @subpackage lexicon
...
$_lang['user_edit_self_msg'] = 'Вам можа спатрэбіцца выйсці і зноў увайсці ў сістэму пасля захавання, каб цалкам абнавіць вашу інфармацыю.<br>Акрамя таго, вы павінны выбраць ці стварыць новы пароль самастойна альбо адправіць яго па электроннай пошце.';
